...
PROGNAME = KanyeStealsThePresidency
...
OFILES = gba.o font.o game.o images/kanye.o images/map.o images/win.o images/trump.o images/biden.o images/embarrassedYe.o images/winScreen.o transition.o the_race.o images/tieScreen.o
